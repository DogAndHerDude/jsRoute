...
(function (factory) {
    ...
    function startChange(ev) {
        ...
        findMatch(nextLocation, function (match) {
            ...
            router_events_1.completeRouteChange(match, routeList, nextLocation);
        });
    }
    exports.startChange = startChange;
    function endChange(ev) {
        var match = ev.detail.match;
        var routeList = ev.detail.routeList;
        var nextLocation = ev.detail.nextLocation;
...
(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define('router/router.events',["require", "exports", '../events/eventHandler', '../location/location.factory', '../utils/utils', '../route/route.observer'], factory);
    }
})(function (require, exports) {
    'use strict';
    ...
    var location_factory_1 = require('../location/location.factory');
    var utils = require('../utils/utils');
    var route_observer_1 = require('../route/route.observer');
    ...
    function completeRouteChange(match, routeList, nextLocation) {
        var root = utils.getRoot();
        eventHandler_1.default('routeChangeSuccess', root, { detail: { match: match, routeList: routeList, nextLocation: nextLocation } });
    }
    exports.completeRouteChange = completeRouteChange;
    function routeChangeFail(routeList) {
        var root = utils.getRoot();
        eventHandler_1.default('routeChangeError', root, { detail: routeList });
    }
    exports.routeChangeFail = routeChangeFail;
    function monitorRouteChange() {
        var root = utils.getRoot();
        root.addEventListener('routeChangeStart', route_observer_1.startChange, false);
    }
    function monitorRouteChangeSuccss() {
        var root = utils.getRoot();
        root.addEventListener('routeChangeSuccess', route_observer_1.endChange, false);
    }
